...
public class Integration {
  ...
  public void addAppForegroundListener(final AppForegroundListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_FOREGROUND)) {
  ...
  public void addAppReopenedListener(final AppReopenedListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_REOPENED)) {
      this.desktop.addAppEventListener(listener);
    }
  }
  ...
  public void addScreenSleepListener(final ScreenSleepListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_SCREEN_SLEEP)) {
      this.desktop.addAppEventListener(listener);
    }
  }
  ...
  public void addSystemSleepListener(final SystemSleepListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_SYSTEM_SLEEP)) {
      this.desktop.addAppEventListener(listener);
    }
  }
  ...
  public void addUserSessionListener(final UserSessionListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_USER_SESSION)) {
      this.desktop.addAppEventListener(listener);
    }
  }
  ...
  public void disableSuddenTermination() {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_SUDDEN_TERMINATION)) {
  ...
  public void
      removeAppForegroundListener(final AppForegroundListener listener) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_EVENT_FOREGROUND)) {
  ...
  public void requestForeground(final boolean allWindows) {
    if (this.supported
        && this.desktop.isSupported(Desktop.Action.APP_REQUEST_FOREGROUND)) {
